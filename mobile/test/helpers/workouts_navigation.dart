...
Future<void> openWorkoutsFromDashboard(
  WidgetTester tester, {
  bool waitForLoad = true,
}) async {
  await pumpUntilStable(tester);
  final quickAction = find.bySemanticsLabel('Open Workouts');
...
Future<void> openCreateWorkoutFromDashboard(WidgetTester tester) async {
